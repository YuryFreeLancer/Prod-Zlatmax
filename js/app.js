(() => {
    ...
    (() => {
        ...
        const menuBlocks = document.querySelectorAll(".sub-menu-catalog__bloсk");
        if (menuBlocks.length) menuBlocks.forEach((menuBlocks => {
            ...
            menuBlocks.classList.add(`sub-menu-catalog__bloсk_${menuBlocksItems}`);
        }));
        function documentAction(e) {
            ...
            if (targetElement.closest("[data-parent]")) {
                ...
                if (subMenu) {
                    ...
                    console.log("11 activeLink", activeLink);
                    const activeBlock = document.querySelector("._sub-menu-open");
                    console.log("22", activeLink && activeLink !== targetElement);
        ...
        if (window.innerWidth > 991.98) {
            const spollerItems = document.querySelectorAll('[data-spoller][class*="filter"]');
            let i;
            for (i = 0; i < spollerItems.length; i++) {
                spollerItems[i].classList.add("_spoller-active");
                console.log(spollerItems[i]);
            }
        }
